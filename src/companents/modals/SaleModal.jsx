...
export default function SaleModal({info, setInfo,open,handleClose,handleOpen}) {
...
const handleSubmit = (e)=>{
  ...
  return (
    <div>
      <Button sx={{marginBottom:"15px"}} onClick={handleOpen} variant='contained'>SALE MODAL</Button>
      <Modal
        open={open}
        onClose={handleClose}
